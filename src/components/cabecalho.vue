  ...
  <div class="cabecalho">
    <nav class="navbar navbar-dark bg-primary p-4 rounded-3">
      <div class="container-fluid">
       ...
       <RouterLink to="/"> <a class="navbar-brand" href="/">SG - Code</a> </RouterLink>
            ...
            <div class="offcanvas offcanvas-start" tabindex="-1" id="offcanvasExample"
              ...
              <div class="offcanvas-body">
                ...
                <div class="dropdown mt-3">
                  <button class="btn btn-secondary dropdown-toggle mb-2" type="button" data-bs-toggle="dropdown">
                  ...
                  <div class="mb-3">
                    <label for="exampleFormControlTextarea1" class="form-label">Conte-nos como melhorar:
                    </label>
                    <textarea class="form-control" id="exampleFormControlTextarea1" rows="3"></textarea>
                    <button type="submit" data-bs-dismiss="offcanvas" class="btn btn-primary m-3">
                      Avaliar
                    </button>
                  </div>
                </div>
                ...
                <div class="offcanvas-body">
                  <form>
                    <div class="form-group">
                      <label for="inputEmail" class="control-label mb-2">Email</label>
                      ...
                      <div class="help-block with-errors mb-2"></div>
                    </div>

                    <div class="form-group">
                      <label for="inputPassword" class="control-label mb-2">Senha</label>
                      <input type="password" class="form-control mb-2" id="inputPassword" placeholder="Digite sua Senha..."
